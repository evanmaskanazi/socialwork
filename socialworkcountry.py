...
if __name__ == "__main__":
    ...
    # Example of global assessment with different countries
    print("\n" + "=" * 90)
    print("EXAMPLES: Global Patient Assessments")
    print("=" * 90)

    # Example 1: Japanese patient
    print("\nExample 1: Japanese Patient")
    print("-" * 40)
    japanese_patient = PatientProfile(
        name="H.T.",
        age=28,
        country="japan",
        city="Tokyo",
        ...
        mental_state="Poor",
        financial_status="moderate_income",
        additional_notes="Works long hours, experiencing work-related stress"
    )

    example_chatbot = GlobalSocialWorkerChatbot()
    jp_health = example_chatbot.assess_country_specific_health_needs(japanese_patient)
    jp_safety = example_chatbot.assess_country_specific_safety_needs(japanese_patient)
    jp_evidence = example_chatbot.generate_country_evidence_recommendations(japanese_patient)
    jp_general = example_chatbot.generate_comprehensive_recommendations(japanese_patient)

    example_chatbot.display_global_assessment(
        japanese_patient, jp_health, jp_safety, jp_evidence, jp_general
    )

    # Example 2: South African patient
    print("\n" + "=" * 90)
    print("Example 2: South African Patient")
    print("-" * 40)
    sa_patient = PatientProfile(
        name="K.M.",
        age=45,
        ...
        exercise_level="Lightly active",
        mental_state="Fair",
        financial_status="low_income",
        additional_notes="Single mother, concerns about community safety"
    )

    sa_health = example_chatbot.assess_country_specific_health_needs(sa_patient)
    sa_safety = example_chatbot.assess_country_specific_safety_needs(sa_patient)
    sa_evidence = example_chatbot.generate_country_evidence_recommendations(sa_patient)
    sa_general = example_chatbot.generate_comprehensive_recommendations(sa_patient)

    example_chatbot.display_global_assessment(
        sa_patient, sa_health, sa_safety, sa_evidence, sa_general
    )